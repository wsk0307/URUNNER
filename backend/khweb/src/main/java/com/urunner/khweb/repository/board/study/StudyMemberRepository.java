...
//    @Query(value = "insert into study_member email, nickname, board_no, introduce value :email, :nickname, :boardNo, :introduce", nativeQuery = true)
//    void applyMember(String email, String nickname, Long boardNo, String introduce);
